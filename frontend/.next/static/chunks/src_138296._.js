(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_138296._.js", {
...
function PaymentMonitor({ payment, onSuccess, onFailure }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PaymentMonitor.useEffect": ()=>{
            ...
            }["PaymentMonitor.useEffect"], 1000);
            // Polling API to check order status
            pollRef.current = setInterval({
                "PaymentMonitor.useEffect": async ()=>{
                    try {
            ...
            }["PaymentMonitor.useEffect"], 120000); // Poll every 2 minutes
            // Cleanup on component unmount
            return ({
                "PaymentMonitor.useEffect": ()=>{
                    if (timerRef.current) clearInterval(timerRef.current);
...
_s(PaymentMonitor, "xM12nVr6lT6zvX9h2E30bkofV6I=", false, function() {
    return [
...
_s(CryptoPayment, "yUfnjfgwtnHgS8MV1SRJLEGa7/I=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=src_138296._.js.map