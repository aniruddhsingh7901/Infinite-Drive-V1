...
const adminDashController_1 = require("../controllers/adminDashController");
const authMiddleware_1 = require("../middleware/authMiddleware");
const sequelize_1 = require("sequelize");
const router = (0, express_1.Router)();
// Dashboard stats
router.get('/dashboard/stats', authMiddleware_1.authenticate, adminDashController_1.getDashboardStats);
...
router.get('/customers/recent', authMiddleware_1.authenticate, async (req, res) => {
    try {
        ...
        const recentCustomers = await Promise.all(users.map(async (user) => {
...
// Analytics
router.get('/analytics', authMiddleware_1.authenticate, adminDashController_1.getAnalytics);
router.get('/analytics/visitors', authMiddleware_1.authenticate, adminDashController_1.getVisitorAnalytics);
router.get('/analytics/visitors/detailed', authMiddleware_1.authenticate, adminDashController_1.getDetailedVisitorAnalytics);
// Abandoned Carts
router.get('/abandoned-carts', authMiddleware_1.authenticate, adminDashController_1.getAbandonedCarts);
router.get('/abandoned-carts/stats', authMiddleware_1.authenticate, adminDashController_1.getAbandonedCartStats);
router.post('/abandoned-carts/:cartId/send-reminder', authMiddleware_1.authenticate, adminDashController_1.sendAbandonedCartReminder);
router.post('/abandoned-carts/:cartId/mark-recovered', authMiddleware_1.authenticate, adminDashController_1.markCartAsRecovered);
// Reviews
router.get('/reviews', authMiddleware_1.authenticate, async (req, res) => {
    try {
...
router.put('/reviews/:id', authMiddleware_1.authenticate, async (req, res) => {
    try {
        const { id } = req.params;
...
// Delete review
router.delete('/reviews/:id', authMiddleware_1.authenticate, async (req, res) => {
    try {
        const { id } = req.params;
        if (id.startsWith('review-')) {
            const orderId = id.replace('review-', '');
...
// FAQs (admin endpoint)
router.get('/faqs', authMiddleware_1.authenticate, async (req, res) => {
    try {
