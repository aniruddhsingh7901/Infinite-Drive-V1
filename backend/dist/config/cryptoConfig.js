...
exports.CRYPTO_CONFIG = {
    ...
    XMR: {
        ...
        qrFormat: (address, amount) => `monero:${address}?tx_amount=${parseFloat(amount).toFixed(12)}`,
    ...
    SOL: {
        ...
        qrFormat: (address, amount) => `solana:${address}?amount=${parseFloat(amount).toFixed(9)}`,
...
exports.default = exports.CRYPTO_CONFIG;
